FirstFix:This Scripts is renaming the Windows Distributions Folder and restart the Windowsupdate Service if windows update has some errors with downloading the newest update
